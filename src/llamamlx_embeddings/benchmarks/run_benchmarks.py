...
def generate_texts(
    num_texts: int = 100, min_words: int = 20, max_words: int = 200
) -> List[str]:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run benchmarks for llamamlx-embeddings"
    )
    parser.add_argument(
        "--models",
        nargs="+",
    ...
    parser.add_argument(
        ...
        type=int,
        default=[1, 8, 32],
        help="Batch size(s) to test",
    )
    parser.add_argument(
        "--num-texts", type=int, default=100, help="Number of texts to benchmark with"
    )
    parser.add_argument(
        "--min-words", type=int, default=50, help="Minimum words per text"
    )
    parser.add_argument(
        "--max-words", type=int, default=200, help="Maximum words per text"
    )
    parser.add_argument(
