...
There are many ways to contribute to LlamaMlx Embeddings:
...
3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamamlx-embeddings.git
   ```
...
By contributing to LlamaMlx Embeddings, you agree that your contributions will be licensed under the project's MIT License.
