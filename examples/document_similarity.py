...
def find_most_similar_pairs(
    documents: List[Dict], similarity_matrix: np.ndarray, top_k: int = 5
...
def main():
    ...
    documents = [
        {
            "id": 1,
            "text": "The MLX framework is designed for Apple Silicon processors.",
            "category": "Tech",
        },
        {
            "id": 2,
            "text": "Apple Silicon processors use the ARM architecture.",
            "category": "Tech",
        },
        {
            "id": 3,
            "text": "MLX is optimized for running efficiently on Apple's M-series chips.",
            "category": "Tech",
        },
        {
            "id": 4,
            "text": "Neural networks consist of layers of artificial neurons.",
            "category": "AI",
        },
        {
            "id": 5,
            "text": "BERT and other transformer models revolutionized NLP.",
            "category": "AI",
        },
        {
            "id": 6,
            "text": "Embeddings are vector representations of text or other data.",
            "category": "AI",
        },
        {
            "id": 7,
            "text": "Text embeddings capture semantic information in dense vectors.",
            "category": "AI",
        },
        {
            "id": 8,
            "text": "Semantic search finds results based on meaning, not just keywords.",
            "category": "Search",
        },
        {
            "id": 9,
            "text": "Vector databases are specialized for storing and querying embeddings.",
            "category": "Search",
        },
        {
            "id": 10,
            "text": "The M1 and M2 chips outperform many laptop processors in efficiency.",
            "category": "Tech",
        },
    ]
    ...
    for i, (doc1, doc2, similarity) in enumerate(top_pairs, 1):
        ...
        print(
            f"   Document 1 (ID: {doc1['id']}, Category: {doc1['category']}): {doc1['text']}"
        )
        print(
            f"   Document 2 (ID: {doc2['id']}, Category: {doc2['category']}): {doc2['text']}"
        )
        print()
    ...
    try:
        ...
        print(
            "Note: Matplotlib is required for visualization. Install it with 'pip install matplotlib'"
        )
