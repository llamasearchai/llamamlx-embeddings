...
def generate_random_texts(
    n_texts: int, min_length: int = 100, max_length: int = 500, seed: int = 42
) -> List[str]:
    """
...
def plot_benchmark_results(
    results: Dict[str, Any], output_file: str = "benchmark_plot.png"
):
    """
...
def benchmark_embedding_model(
    ...
    for text_length in text_lengths:
        ...
        texts = generate_random_texts(
            100, min_length=text_length, max_length=text_length
        )
        ...
        for batch_size in batch_sizes:
            ...
            logger.info(
                f"    Average time: {avg_time:.4f}s, Throughput: {throughput:.2f} texts/s"
            )
...
def main():
    ...
    try:
        ...
        for result in all_results:
            ...
            for measurement in result["measurements"]:
                if measurement["text_length"] == 512:
                    ...
                    model_data["throughputs"].append(
                        measurement["throughput_texts_per_second"]
                    )
        ...
        for model_data in models_data:
            plt.plot(
                model_data["batch_sizes"],
                model_data["throughputs"],
                marker="o",
